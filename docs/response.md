...
La clase `Response` permite enviar respuestas HTTP de forma uniforme en todo el framework, ya sea en **texto plano** o **formato JSON**, con soporte para códigos de estado comunes.
