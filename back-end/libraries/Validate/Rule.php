...
abstract class Rule
{
    ...
    public static function isImage($imageBase64)
    {
        $parts = explode(',', $imageBase64);
		return imagecreatefromstring(base64_decode($parts[1]));
    }

    public static function imageSizeIsLessThan($image, $size) { return getimagesizefromstring($image) < $size; }
