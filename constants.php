...
define('PATH_RESOURCES_PUBLIC', PATH_BASE . DIRECTORY_SEPARATOR . 'resources' . DIRECTORY_SEPARATOR . 'public');
define('PATH_RESOURCES_PRIVATE', PATH_BASE . DIRECTORY_SEPARATOR . 'resources' . DIRECTORY_SEPARATOR . 'private');
